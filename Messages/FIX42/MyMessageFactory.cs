...
namespace QuickFix
{
    namespace FIX42
    {
        ...
        {
            private static readonly ProducerConsumerBuffer<ExecutionReport> _executionReportBuffer =
                new ProducerConsumerBuffer<ExecutionReport>(512, true, true, () => new ExecutionReport());
            private static readonly ProducerConsumerBuffer<NewOrderSingle> _newSingleBuffer =
                new ProducerConsumerBuffer<NewOrderSingle>(1024, true, true, () => new NewOrderSingle());
            private static readonly ProducerConsumerBuffer<OrderCancelReplaceRequest> _orderReplaceBuffer =
                new ProducerConsumerBuffer<OrderCancelReplaceRequest>(1024, true, true, () => new OrderCancelReplaceRequest());
            private static readonly ProducerConsumerBuffer<OrderCancelRequest> _orderCancelBuffer =
                new ProducerConsumerBuffer<OrderCancelRequest>(1024, true, true, () => new OrderCancelRequest());
            ...
            public QuickFix.Message Create(string beginString, string msgType)
            {
                switch (msgType)
                {
                    ...
                    case QuickFix.FIX42.NewOrderSingle.MsgType: return _newSingleBuffer.Dequeue();
                    case QuickFix.FIX42.ExecutionReport.MsgType: return _executionReportBuffer.Dequeue();
                    case QuickFix.FIX42.DontKnowTrade.MsgType: return new QuickFix.FIX42.DontKnowTrade();
                    case QuickFix.FIX42.OrderCancelReplaceRequest.MsgType: return _orderReplaceBuffer.Dequeue();
                    case QuickFix.FIX42.OrderCancelRequest.MsgType: return _orderCancelBuffer.Dequeue();
            ...
            public static void TryReturn(QuickFix.Message m)
            {
                if (m.GetType() == typeof(ExecutionReport))
                    _executionReportBuffer.Enqueue((ExecutionReport)m);
                else if (m.GetType() == typeof(NewOrderSingle))
                    _newSingleBuffer.Enqueue((NewOrderSingle)m);
                else if (m.GetType() == typeof(OrderCancelRequest))
                    _orderCancelBuffer.Enqueue((OrderCancelRequest)m);
                else if (m.GetType() == typeof(OrderCancelReplaceRequest))
                    _orderReplaceBuffer.Enqueue((OrderCancelReplaceRequest)m);
            }

            public static NewOrderSingle GetNewOrderSingle()
            {
                var message = _newSingleBuffer.Dequeue();
                message.ClearAndInitialize();
                return message;
            }

            public static OrderCancelRequest GetOrderCancelRequest()
            {
                var message = _orderCancelBuffer.Dequeue();
                message.ClearAndInitialize();
                return message;
            }

            public static OrderCancelReplaceRequest GetOrderCancelReplaceRequest()
            {
                var message = _orderReplaceBuffer.Dequeue();
                message.ClearAndInitialize();
                return message;
            }
        }
