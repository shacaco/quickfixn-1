...
namespace UnitTests
{
    ...
    public class FileStoreTests
    {
        ...
        public void Setup()
        {
            ...
            _store = _factory.Create(_sessionID);
        }
        ...
        public void TestPrefixForSessionWithSubsAndLoc()
        {
            ...
            Assert.That(QuickFix.Store.FileStore.Prefix(sessionIDWithSubsAndLocation), Is.EqualTo("FIX.4.2-SENDERCOMP_SENDERSUB_SENDERLOC-TARGETCOMP_TARGETSUB_TARGETLOC"));

            QuickFix.SessionID sessionIDWithSubsNoLocation = new QuickFix.SessionID("FIX.4.2", "SENDERCOMP", "SENDERSUB", "TARGETCOMP", "TARGETSUB");
            Assert.That(QuickFix.Store.FileStore.Prefix(sessionIDWithSubsNoLocation), Is.EqualTo("FIX.4.2-SENDERCOMP_SENDERSUB-TARGETCOMP_TARGETSUB"));
        }
